...
$pdf = new FPDF();
$pdf->Image('../imagenes/3col.jpg', 10, 10, 16);
...
$pdf->Cell(80, 12, utf8_decode('INFORMACIÓN GENERAL DE USUARIO'), 0, 'C');
$pdf->Ln(12);
...
//realizar consulta
$consulta = "select cedula, nombre, apellido, direccion, telefono from funcionarios";
...
$pdf ->Output("C:\\reportes\\".$fechar.".pdf",'F');
